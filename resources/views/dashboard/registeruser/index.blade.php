...
$(document).ready(function() {
    ...
    var datatable = $('#data_Table').DataTable({
        ...
        "ajax": {
            "url": "{{ route('dashboard_registereduser.get_data') }}",
            "dataType": "json",
            "type": "POST",
            "data": {
                _token: "{{csrf_token()}}"
    ...
    $(document).on('click', '.ajax_delete_all', function() {
        $.ajax({
            url: "{{ route('dashboard_registereduser.deleted_all') }}",
            method: "get",
            data: {
                "array": array,
            },
    ...
    $('.btn_deleted').on("click", function() {
        ...
        console.log(id);
        $.ajax({
            url: "{{ route('dashboard_registereduser.deleted') }}",
            method: "get",
            data: {
                "id": id,
            },
    ...
    $(document).on('click', '.btn_confirm_email_current', function() {
        ...
        $.ajax({
            url: "{{ route('dashboard_registereduser.confirm_email') }}",
            method: "get",
            data: {
                "id": id,
            },
