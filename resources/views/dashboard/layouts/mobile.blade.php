    ...
    <div class="container-fluid">
        <div class="d-flex">
            ...
            <a class="header-brand" href="index.html">
                <img src="{{$path}}login_style/assets/img/CompositeLayer@1X.png" class="header-brand-img desktop-logo"
                    alt="logo">
                <img src="{{$path}}login_style/assets/img/CompositeLayer@1X.png"
            ...
            <div class="d-flex order-lg-2 ml-auto header-right-icons">
                ...
                <div class="dropdown profile-1">
                    <a href="#" data-toggle="dropdown" class="nav-link pr-2 leading-none d-flex">
                        <span>
                            <img src="{{$path.$user->avatar}}" alt="profile-user"
