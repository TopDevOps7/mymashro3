...
Discount
@endsection
@section('create_btn'){{route('dashboard_discount.add_edit')}}@endsection
...
$(document).ready(function() {
    ...
    var datatable = $('#data_Table').DataTable({
        ...
        "ajax": {
            "url": "{{ route('dashboard_discount.get_data') }}",
            "dataType": "json",
            "type": "POST",
            "data": {
                _token: "{{csrf_token()}}"
    ...
    $(document).on('click', '.ajax_delete_all', function() {
        $.ajax({
            url: "{{ route('dashboard_discount.deleted_all') }}",
            method: "get",
            data: {
                "array": array,
            },
    ...
    $('.btn_deleted').on("click", function() {
        ...
        console.log(id);
        $.ajax({
            url: "{{ route('dashboard_discount.deleted') }}",
            method: "get",
            data: {
                "id": id,
            },
