...
Advertisement
@endsection
@section('create_btn'){{route('dashboard_advertisementother.add_edit')}}@endsection
...
$(document).ready(function() {
    $(document).on('change', '#priority', function() {
        ...
        $.ajax({
            url: "{{route('dashboard_advertisementother.get_data_by_iddata')}}",
            method: "get",
            data: {
                "id": priorityid,
                "value": priorityvalue
    ...
    var datatable = $('#data_Table').DataTable({
        ...
        "ajax": {
            "url": "{{ route('dashboard_advertisementother.get_data') }}",
            "dataType": "json",
            "type": "POST",
            "data": {
                _token: "{{csrf_token()}}"
    ...
    $(document).on('click', '.btn_confirm_email_current', function() {
        ...
        $.ajax({
            url: "{{ route('dashboard_advertisementother.confirm_email') }}",
            method: "get",
            data: {
                "id": id,
            },
    ...
    $(document).on('click', '.ajax_delete_all', function() {
        $.ajax({
            url: "{{ route('dashboard_advertisementother.deleted_all') }}",
            method: "get",
            data: {
                "array": array,
            },
    ...
    $('.btn_deleted').on("click", function() {
        ...
        console.log(id);
        $.ajax({
            url: "{{ route('dashboard_advertisementother.deleted') }}",
            method: "get",
            data: {
                "id": id,
            },
